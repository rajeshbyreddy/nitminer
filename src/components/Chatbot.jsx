    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 bg-blue-600 hover:bg-blue-700 text-white p-4 rounded-full shadow-2xl transition-all duration-300 z-50 hover:scale-110"
          ...
          <div className="p-5 bg-white dark:bg-zinc-900 border-t-2 border-gray-200 dark:border-zinc-800">
            <div className="flex gap-3">
              <input
                ...
                className="flex-1 px-4 py-3 bg-slate-50 dark:bg-zinc-800 rounded-xl focus:ring-2 focus:ring-blue-600 focus:outline-none dark:text-white font-medium border-2 border-gray-200 dark:border-zinc-700"
                disabled={isLoading}
              />
              <button
                onClick={sendMessage}
                disabled={isLoading || !inputMessage.trim()}
                className="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white p-3 rounded-xl transition-colors shadow-lg hover:shadow-xl disabled:cursor-not-allowed"
