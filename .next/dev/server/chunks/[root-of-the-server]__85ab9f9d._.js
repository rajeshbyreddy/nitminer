...
async function GET(req) {
    try {
        ...
        if (search) {
            ...
            const users = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["User"].find({
                $or: [
                    {
                        name: {
                            $regex: search,
        ...
        const payments = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Payment$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Payment"].find(query).populate('userId', 'name email').sort({
            createdAt: -1
        }).skip(skip).limit(limit).lean();
        const total = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Payment$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Payment"].countDocuments(query);
        const totalPages = Math.ceil(total / limit);
        // Calculate total revenue and successful payments count
        const revenueResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Payment$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Payment"].aggregate([
            {
                $match: {
                    status: 'success'
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__85ab9f9d._.js.map