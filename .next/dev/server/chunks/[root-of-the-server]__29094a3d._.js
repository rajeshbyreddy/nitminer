...
"[project]/src/app/api/auth/verify-status/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const hasPremium = user.isPremium || user.subscription?.status === 'active' && user.subscription.endDate > new Date();
        ...
        if (hasPremium) {
            if (user.subscription?.plan) {
                currentPlan = user.subscription.plan === '1_month' ? '1 Month' : user.subscription.plan === '6_months' ? '6 Months' : '12 Months';
...
//# sourceMappingURL=%5Broot-of-the-server%5D__29094a3d._.js.map