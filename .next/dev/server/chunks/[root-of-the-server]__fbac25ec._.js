...
"[project]/src/app/api/auth/session/check-duplicate/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (!email || !deviceId || !deviceFingerprint) {
            console.warn('check-duplicate: Missing required fields', {
                email,
                deviceId,
                browser
            });
        ...
        const activeSessions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$SessionManagement$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SessionManagement"].find({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fbac25ec._.js.map