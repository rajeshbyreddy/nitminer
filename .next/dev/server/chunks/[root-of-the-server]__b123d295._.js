...
"[project]/src/app/api/user/logs/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const logs = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$UsageLog$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UsageLog"].find({
            userId: session.user.id
        }).sort({
            timestamp: -1
        }).skip(skip).limit(limit).lean();
        const total = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$UsageLog$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UsageLog"].countDocuments({
            userId: session.user.id
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            logs,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b123d295._.js.map