...
"[project]/src/app/api/user/payments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const payments = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Payment$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Payment"].find({
            userId: session.user.id,
            status: 'success'
        }).sort({
            createdAt: -1
        }).skip(skip).limit(limit).lean();
        const total = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Payment$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Payment"].countDocuments({
            userId: session.user.id,
            status: 'success'
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__df74425b._.js.map