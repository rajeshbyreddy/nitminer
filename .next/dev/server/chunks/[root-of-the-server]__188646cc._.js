...
async function POST(req) {
    try {
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendPaymentSuccessEmail"])(user.email, user.name, payment.amount, payment.plan.replace('_', ' ').toUpperCase(), receiptUrl, user.subscription.endDate.toLocaleDateString('en-IN'), razorpay_payment_id);
