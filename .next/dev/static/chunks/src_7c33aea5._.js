...
function ThemeProvider(t0) {
    ...
    if ($[0] !== "b8ddab93a0ec10db70361adddab79270f088afe1195dd1986af8f4031c5733a7") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "b8ddab93a0ec10db70361adddab79270f088afe1195dd1986af8f4031c5733a7";
    }
    let children;
    let props;
    if ($[1] !== t0) {
...
"[project]/src/hooks/useSessionValidator.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useSessionValidator() {
    ...
    if ($[0] !== "01a969311b11fb4ec56ef0f67a0953086d9eb7c0668ce1158088b49f27cd62d5") {
        for(let $i = 0; $i < 12; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "01a969311b11fb4ec56ef0f67a0953086d9eb7c0668ce1158088b49f27cd62d5";
    }
    ...
    const sessionTokenRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    let t0;
    if ($[1] !== session?.user?.email || $[2] !== status) {
        t0 = ({
            "useSessionValidator[useEffect()]": ()=>{
    ...
    if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = ({
            "useSessionValidator[validateSession]": async ()=>{
        ...
        })["useSessionValidator[validateSession]"];
        $[7] = t2;
    } else {
        t2 = $[7];
    }
    const validateSession = t2;
    let t3;
    let t4;
    if ($[8] !== status) {
        t3 = ({
            "useSessionValidator[useEffect()]": ()=>{
                if (status === "authenticated" && sessionTokenRef.current) {
                    validateSession();
                    checkIntervalRef.current = setInterval(validateSession, 300000);
                    return ()=>{
...
_s(useSessionValidator, "GfpyIAKMlVz2EhLqSUAAFlKGxvo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSession"]
    ];
});
function useStorageSessionListener() {
    _s1();
    ...
    if ($[1] !== status) {
        t0 = ({
            "useStorageSessionListener[useEffect()]": ()=>{
                if (status !== "authenticated") {
                    return;
                }
                const handleStorageChange = _useStorageSessionListenerUseEffectHandleStorageChange;
...
_s1(useStorageSessionListener, "TY4A9+bvfAkJbaZPAKQrtzvGqPU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSession"]
    ];
});
async function _useStorageSessionListenerUseEffectHandleStorageChange(e) {
...
function SessionProvider(t0) {
    ...
    if ($[0] !== "6ac5e2e899fba881b1064632c3810f55a7d2148b9edf911f608ead91a00a3cfb") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "6ac5e2e899fba881b1064632c3810f55a7d2148b9edf911f608ead91a00a3cfb";
    }
    const { children } = t0;
...
_s(SessionProvider, "R/uUzoSI6JjWA2aLM+Cduw7eBCw=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/compiler-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$theme$2d$provider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/theme-provider.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next-auth/react/index.js [app-client] (ecmascript)");
...
function Providers(t0) {
    ...
    if ($[0] !== "5c512b0e35f6e06269d304c9797ea915d8dd08791ec5374f36605a5dce03ce23") {
        for(let $i = 0; $i < 3; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "5c512b0e35f6e06269d304c9797ea915d8dd08791ec5374f36605a5dce03ce23";
    }
    const { children } = t0;
    let t1;
    if ($[1] !== children) {
...
function Footer() {
    ...
    if ($[0] !== "b9ee1cf8f250e0f5ecf3d08257d531bac745a8ffee5f398b84a797c868b27032") {
        for(let $i = 0; $i < 16; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "b9ee1cf8f250e0f5ecf3d08257d531bac745a8ffee5f398b84a797c868b27032";
    }
    let t0;
    ...
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        ...
        t4 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            className: "text-gray-600 dark:text-gray-400 mb-6 leading-relaxed font-medium",
            children: "Pioneering innovation in Blockchain, AI, and Cloud Solutions. Bridging academic research with industrial applications."
        }, void 0, false, {
            fileName: "[project]/src/components/Footer.jsx",
            lineNumber: 64,
            columnNumber: 10
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Innovation hub at NIT Warangal"
                        }, void 0, false, {
                            fileName: "[project]/src/components/Footer.jsx",
                            lineNumber: 73,
                            columnNumber: 159
    ...
    if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
        ...
        t10 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            className: "text-gray-600 dark:text-gray-400 mb-6 font-medium",
    ...
    if ($[14] === Symbol.for("react.memo_cache_sentinel")) {
        t13 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            className: "text-gray-600 dark:text-gray-400 text-center md:text-left font-medium",
            children: [
                "© ",
                currentYear,
                " NITMiner Technologies. All rights reserved."
            ]
        }, void 0, true, {
            fileName: "[project]/src/components/Footer.jsx",
            lineNumber: 127,
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                t13,
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex gap-6 text-gray-600 dark:text-gray-400 text-sm font-medium",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                            href: "#",
...
function Chatbot() {
    ...
    const [messages, setMessages] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        {
            role: 'assistant',
            content: '**Hello!** I\'m your **TrustInn assistant**. I can help you with information about our security analysis platform, pricing, tools, and more.\n\n**How can I assist you today?**'
        }
    ]);
    ...
    const sendMessage = async ()=>{
        ...
        try {
            const response = await fetch('https://api.perplexity.ai/chat/completions', {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${("TURBOPACK compile-time value", "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")}`,
                    'Content-Type': 'application/json'
                },
                body: JSON.stringify({
                    model: 'sonar',
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$styled$2d$jsx$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                id: "efdab0f81ae82c0c",
                children: '@import "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&family=Space+Grotesk:wght@400;500;600;700&display=swap";.chatbot-markdown h2{color:inherit;margin-top:1rem;margin-bottom:.75rem;font-family:Space Grotesk,sans-serif;font-size:1.25rem;font-weight:900}.chatbot-markdown h3{color:inherit;margin-top:.875rem;margin-bottom:.5rem;font-family:Space Grotesk,sans-serif;font-size:1.1rem;font-weight:800}.chatbot-markdown strong{font-family:Space Grotesk,sans-serif;font-weight:800}.chatbot-markdown ul,.chatbot-markdown ol{margin-top:.5rem;margin-bottom:.5rem;margin-left:1.25rem}.chatbot-markdown li{margin-bottom:.375rem}.chatbot-markdown p{margin-bottom:.75rem}.chatbot-markdown blockquote{opacity:.9;border-left:3px solid #3b82f6;margin:.75rem 0;padding-left:.75rem;font-style:italic}.chatbot-markdown hr{border:none;border-top:2px solid #0000001a;margin:1rem 0}.dark .chatbot-markdown hr{border-top-color:#ffffff1a}'
            ...
            !isOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                className: "jsx-efdab0f81ae82c0c" + " " + "fixed bottom-6 right-6 bg-blue-600 hover:bg-blue-700 text-white p-4 rounded-full shadow-2xl transition-all duration-300 z-50 hover:scale-110",
            ...
            isOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                className: "jsx-efdab0f81ae82c0c" + " " + "fixed bottom-6 right-6 w-96 h-[600px] bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl z-50 flex flex-col overflow-hidden border-2 border-gray-200 dark:border-zinc-800",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "jsx-efdab0f81ae82c0c" + " " + "flex items-center justify-between p-5 bg-blue-600 text-white",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "jsx-efdab0f81ae82c0c",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                        style: {
                                            fontFamily: 'Space Grotesk, sans-serif'
                                        },
                                        className: "jsx-efdab0f81ae82c0c" + " " + "text-lg font-black",
                                        children: "TrustInn Assistant"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/Chatbot.jsx",
                                        lineNumber: 336,
                                        columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "jsx-efdab0f81ae82c0c" + " " + "text-xs font-semibold opacity-90",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "jsx-efdab0f81ae82c0c" + " " + "flex gap-2",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: ()=>setIsOpen(false),
                                        "aria-label": "Minimize",
                                        className: "jsx-efdab0f81ae82c0c" + " " + "text-white/80 hover:text-white hover:bg-white/10 p-2 rounded-lg transition-all",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "jsx-efdab0f81ae82c0c" + " " + "flex-1 overflow-y-auto p-6 space-y-4 bg-slate-50 dark:bg-black",
                        children: [
                            messages.map((message, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "jsx-efdab0f81ae82c0c" + " " + `flex ${message.role === 'user' ? 'justify-end' : 'justify-start'}`,
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "jsx-efdab0f81ae82c0c" + " " + `max-w-[85%] p-4 rounded-2xl shadow-md ${message.role === 'user' ? 'bg-blue-600 text-white' : 'bg-white dark:bg-zinc-800 text-gray-900 dark:text-white'}`,
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "jsx-efdab0f81ae82c0c" + " " + "text-sm font-medium leading-relaxed chatbot-markdown",
                            ...
                            isLoading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "jsx-efdab0f81ae82c0c" + " " + "flex justify-start",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "jsx-efdab0f81ae82c0c" + " " + "bg-white dark:bg-zinc-800 p-4 rounded-2xl shadow-md",
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "jsx-efdab0f81ae82c0c" + " " + "flex space-x-2",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "jsx-efdab0f81ae82c0c" + " " + "w-2 h-2 bg-blue-600 rounded-full animate-bounce"
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/Chatbot.jsx",
                                                lineNumber: 365,
                                                columnNumber: 21
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "jsx-efdab0f81ae82c0c" + " " + "p-5 bg-white dark:bg-zinc-900 border-t-2 border-gray-200 dark:border-zinc-800",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "jsx-efdab0f81ae82c0c" + " " + "flex gap-3",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                    type: "text",
                                    value: inputMessage,
                                    onChange: (e_0)=>setInputMessage(e_0.target.value),
                                    onKeyPress: handleKeyPress,
                                    placeholder: "Ask about TrustInn...",
                                    disabled: isLoading,
                                    className: "jsx-efdab0f81ae82c0c" + " " + "flex-1 px-4 py-3 bg-slate-50 dark:bg-zinc-800 rounded-xl focus:ring-2 focus:ring-blue-600 focus:outline-none dark:text-white font-medium border-2 border-gray-200 dark:border-zinc-700"
                                }, void 0, false, {
                                    fileName: "[project]/src/components/Chatbot.jsx",
                                    lineNumber: 381,
                                    columnNumber: 15
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    className: "jsx-efdab0f81ae82c0c" + " " + "bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white p-3 rounded-xl transition-colors shadow-lg hover:shadow-xl disabled:cursor-not-allowed",
...
_s(Chatbot, "ltg078gntoqDUSntL/ABFyGMxB0=");
_c = Chatbot;
var _c;
...
//# sourceMappingURL=src_7c33aea5._.js.map