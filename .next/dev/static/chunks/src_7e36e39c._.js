...
"[project]/src/components/ImageCarousel.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ImageCarousel() {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(12);
    if ($[0] !== "945dab0826382e280ed9ec9c6dd5d7ff5d443cc2b0cbc7f2e3ba73a7d171130c") {
        for(let $i = 0; $i < 12; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "945dab0826382e280ed9ec9c6dd5d7ff5d443cc2b0cbc7f2e3ba73a7d171130c";
    }
        ...
        t0 = ({
            "ImageCarousel[useEffect()]": ()=>{
                ...
                const timer = setInterval({
                    "ImageCarousel[useEffect() > setInterval()]": ()=>{
                        api.scrollNext();
                    }
                }["ImageCarousel[useEffect() > setInterval()]"], 5000);
                api.on("select", {
                    "ImageCarousel[useEffect() > api.on()]": ()=>{
    ...
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$carousel$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CarouselContent"], {
            children: carouselImages.map(_ImageCarouselCarouselImagesMap)
        }, void 0, false, {
    ...
    let t5;
    if ($[7] !== api || $[8] !== current) {
        t5 = carouselImages.map({
            "ImageCarousel[carouselImages.map()]": (_, index_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    className: `h-2 rounded-full transition-all duration-300 ${current === index_0 ? "w-8 bg-white" : "w-2 bg-white/50 hover:bg-white/75"}`,
                    onClick: {
                        "ImageCarousel[carouselImages.map() > <button>.onClick]": ()=>api?.scrollSnapToIndex(index_0)
                    }["ImageCarousel[carouselImages.map() > <button>.onClick]"],
        ...
        }["ImageCarousel[carouselImages.map()]"]);
        $[7] = api;
        $[8] = current;
        $[9] = t5;
    } else {
...
_s(ImageCarousel, "Y26xKFJ+b5tF6fKPTsyIcVwh5zk=");
_c = ImageCarousel;
function _ImageCarouselCarouselImagesMap(image, index) {
...
//# sourceMappingURL=src_7e36e39c._.js.map