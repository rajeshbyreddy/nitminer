...
function Providers(t0) {
    ...
    if ($[0] !== "7a2a3ef13c39caf0e0fc98dc3bb748ed70edbe7e2b272a4510639886b8c85fad") {
        for(let $i = 0; $i < 3; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "7a2a3ef13c39caf0e0fc98dc3bb748ed70edbe7e2b272a4510639886b8c85fad";
    }
    const { children } = t0;
    let t1;
    if ($[1] !== children) {
...
//# sourceMappingURL=src_components_8679d23a._.js.map